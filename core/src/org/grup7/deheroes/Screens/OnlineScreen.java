...
public class OnlineScreen implements Screen {
    ...
    private final TiledMapRenderer renderer = new OrthogonalTiledMapRenderer(AssetManager.map);
    ...
    public OnlineScreen(Batch prevBatch, Viewport prevViewport) {
        ...
        TiledMapTileLayer collisionLayer = (TiledMapTileLayer) AssetManager.map.getLayers().get("collision");
